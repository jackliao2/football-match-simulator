...
export const HUB_COPY: Record<string, HubCopy> = {
  ...
  "athletic-bilbao": {
    kicker: "Athletic Bilbao 1983/84",
  ...
  "manchester-united": {
    kicker: "Manchester United squads",
  ...
  "nottingham-forest": {
    kicker: "Nottingham Forest 1979/80",
  ...
  "bayer-leverkusen": {
    kicker: "Bayer Leverkusen 2023/24",
