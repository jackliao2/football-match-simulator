...
export const primeEntities: PrimeEntity[] = [
  {
    ...
    pick: "2010/11",
    description:
      "Barcelona's modern peak is a three-way argument: Guardiola's first treble, the Wembley tiki-taka side, or the MSN treble.",
    seoTitle: "Barcelona Prime: 2010/11 Wembley, Not 2009 or MSN",
    seoDescription:
      "Barcelona's prime is 2010/11: Messi's false nine, Wembley, Xavi and Iniesta. Compare the 2008/09 treble and MSN 2014/15 — not the same team twice.",
  ...
  },
  {
    ...
    seoDescription:
      "Real Madrid's prime here is Zidane 2016/17 — league plus a retained Champions League — not only La Décima. 2013/14 is the emotional counter.",
  ...
  },
  {
    ...
    seoDescription:
      "Manchester United's strongest XI is 2007/08: peak Ronaldo, Moscow, Ferdinand and Vidić. The 1998/99 treble remains the greater achievement.",
  ...
  },
  {
    ...
    pick: "1970",
    description:
      "1958, 1970, 1994 or 2002? Pelé twice, Romário in the heat, or the three R's. Four World Cups, four different answers.",
    seoTitle: "Brazil Prime: 1970, Not 1958 or the Three R's",
    seoDescription:
      "Brazil's prime is Mexico 1970: Pelé, Jairzinho, a 4–1 final. 1958 announced him; 2002 restored the three R's.",
  ...
  },
  {
    ...
    seoDescription:
      "Argentina's collective prime is Qatar 2022. Mexico 1986 is the stronger one-player World Cup. Two captains, two different questions.",
  ...
  },
  {
    ...
    seoDescription:
      "Chelsea's prime is Mourinho 2004/05: 95 points, 15 conceded. Munich 2012 won Europe the hard way. Do not merge those two Chelses.",
  ...
  },
  {
    ...
    pick: "1988/89",
    description:
      "Sacchi's pressing 1988/89 European Cup winners, or Ancelotti's Christmas-tree side that won Athens in 2007. Two European Cups, two ideas.",
    seoTitle: "AC Milan Prime: Sacchi 1988/89, Not Athens 2007",
    seoDescription:
      "AC Milan's prime is Sacchi 1988/89: Baresi, the Dutch trio, a 4–0 European Cup final. Athens 2007 is the experienced counter.",
  ...
  },
  {
    ...
    seoDescription:
      "Spain's playing prime is Euro 2012, the 4–0 final. 2010 owns the World Cup. Del Bosque twice; the midfield was the event.",
  ...
  },
  {
    ...
    pick: "1966",
    description:
      "1966 at Wembley, the golden generation of 2004, or Southgate's 2018 run. More than one England — including sides that never lifted a trophy.",
    seoTitle: "England Prime: 1966, Not the Golden Generation",
    seoDescription:
      "England's prime is still 1966. The 2004 golden generation wins the names-on-paper argument; 2018 restored belief. Neither converted into a final.",
  ...
  },
  {
    ...
    seoDescription:
      "Liverpool's stronger side is Klopp 2018/19, not Istanbul. Benítez 2004/05 is the greater story; Salah, Mané and van Dijk are the stronger football team.",
    verdict:
