...
export const TROPHIES: Record<string, Trophy[]> = {
  ...
  "denmark-1992": [euros()],
  "denmark-1998": [],
  "everton-1984-85": [league(), cup()],
  "leeds-united-1973-74": [league()],
  "nottingham-forest-1979-80": [ucl()],
  "newcastle-1995-96": [],
  "aston-villa-1981-82": [ucl()],
  "sevilla-2005-06": [el()],
  "valencia-2003-04": [league(), el()],
  "athletic-bilbao-1983-84": [league(), cup()],
  "as-roma-2000-01": [league()],
  "lazio-1999-00": [league(), cup()],
  "bayer-leverkusen-2023-24": [league(), cup()],
  "borussia-monchengladbach-1974-75": [league(), el()],
  "marseille-1992-93": [ucl()],
  "lyon-2005-06": [league()],
  "monaco-2016-17": [league()],
  "benfica-1961-62": [ucl()],
  "sporting-2001-02": [league()],
  "psv-1987-88": [ucl()],
  "feyenoord-1969-70": [ucl()],
  "celtic-1966-67": [ucl()],
  "rangers-1992-93": [league()],
  "red-star-1990-91": [ucl()],
  "steaua-1985-86": [ucl()],
  "galatasaray-1999-00": [el()],
  "santos-1962": [copa()],
  "flamengo-1981": [copa()],
  "boca-juniors-2000": [copa()],
  "river-plate-2018": [copa()],
  "mexico-1986": [],
  "sweden-1994": [],
  "greece-2004": [euros()],
  "turkey-2002": [],
