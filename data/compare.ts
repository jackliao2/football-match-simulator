...
export const CLUB_COMPARES: ClubCompare[] = [
  ...
  },
  {
    ...
    title: "AC Milan or Inter — Which Is Better?",
    description:
      "AC Milan or Inter Milan: Sacchi’s European Cup side against Mourinho’s treble winners. Compare the Derby della Madonnina at their peaks.",
    keywords: keywords("AC Milan", "Inter", ["milan or inter which is better", "derby della madonnina"]),
