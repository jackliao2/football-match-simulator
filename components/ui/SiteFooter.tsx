...
export function SiteFooter() {
  ...
  const copy = locale === "es" ? {
    ...
    explore: "Explorar", legal: "Información", simulator: "Simulador", teams: "Clubes", nations: "Selecciones", search: "Buscar", dreams: "Duelos", best: "Mejor equipo", compare: "Comparar clubes", aboutPage: "Acerca del proyecto", methodology: "Metodología", terms: "Términos", privacy: "Privacidad", contact: "Contacto", status: "Simulación independiente · 2026",
  } : locale === "pt-br" ? {
    ...
    explore: "Explorar", legal: "Informações", simulator: "Simulador", teams: "Clubes", nations: "Seleções", search: "Buscar", dreams: "Duelos", best: "Melhor time", compare: "Comparar clubes", aboutPage: "Sobre o projeto", methodology: "Metodologia", terms: "Termos", privacy: "Privacidade", contact: "Contato", status: "Simulação independente · 2026",
  } : {
    ...
    explore: "Explore", legal: "Information", simulator: "Simulator", teams: "Teams", nations: "Nations", search: "Search", dreams: VS_HUB.crumb, best: "Best team ever", compare: "Compare clubs", aboutPage: "About", methodology: "Methodology", terms: "Terms", privacy: "Privacy", contact: "Contact", status: "Independent simulation · 2026",
  }
  return (
