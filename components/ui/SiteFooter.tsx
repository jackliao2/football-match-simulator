...
export function SiteFooter() {
  ...
  const copy = locale === "es" ? {
    ...
    explore: "Explorar", legal: "Información", simulator: "Simulador", teams: "Clubes", nations: "Selecciones", dreams: "Partidos soñados", best: "Mejor equipo", compare: "Comparar clubes", aboutPage: "Acerca del proyecto", methodology: "Metodología", terms: "Términos", privacy: "Privacidad", contact: "Contacto", status: "Simulación independiente · 2026",
  } : locale === "pt-br" ? {
    ...
    explore: "Explorar", legal: "Informações", simulator: "Simulador", teams: "Clubes", nations: "Seleções", dreams: "Jogos dos sonhos", best: "Melhor time", compare: "Comparar clubes", aboutPage: "Sobre o projeto", methodology: "Metodologia", terms: "Termos", privacy: "Privacidade", contact: "Contato", status: "Simulação independente · 2026",
  } : {
    ...
    explore: "Explore", legal: "Information", simulator: "Simulator", teams: "Teams", nations: "Nations", dreams: "Dream matches", best: "Best team ever", compare: "Compare clubs", aboutPage: "About", methodology: "Methodology", terms: "Terms", privacy: "Privacy", contact: "Contact", status: "Independent simulation · 2026",
  }
  return (
    <footer className="site-footer">
      <div className="site-footer-inner">
        ...
        <nav className="site-footer-nav" aria-label="Footer navigation">
          <div>
            <p>{copy.explore}</p>
            <Link href={`${prefix}/simulate`}>{copy.simulator}</Link><Link href={`${prefix}/teams`}>{copy.teams}</Link><Link href={`${prefix}/national-teams`}>{copy.nations}</Link><Link href={`${prefix}/vs`}>{copy.dreams}</Link><Link href="/prime">Prime</Link><Link href="/best-football-team-ever">{copy.best}</Link><Link href="/compare">{copy.compare}</Link>
          </div>
          <div>
            <p>{copy.legal}</p>
