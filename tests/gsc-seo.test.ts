...
describe("GSC landing pages", () => {
  ...
  it("gives collection hubs a named verdict instead of a factory query", () => {
    ...
    expect(HOME_SECTIONS.matchupsKicker).toBe("Dream matches")
    expect(HOME_SECTIONS.clubsKicker).toBe("Legendary clubs")
    expect(HOME_SECTIONS.nationsKicker).toBe("Legendary nations")
    expect(HOME_SECTIONS.howKicker).toBe("How it works")
    expect(HOME_SECTIONS.faqKicker).toBe("FAQ")
    expect(HOME_SECTIONS.argumentsKicker).toBe("Who is better?")
  ...
  it("drops factory section kickers from prime, best-team, home and compare chrome", () => {
    ...
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).toMatch(/dream: "Random matchup"/)
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).not.toMatch(/Roll a new night, not/)
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).not.toMatch(/Roll Barça vs Madrid/)
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).not.toMatch(/Swap \$\{codes\}/)
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).not.toMatch(/faceoff-vs">\{shownHome\.clubCode\}/)
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).not.toMatch(/daily: home\.clubCode/)
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).not.toMatch(/daily: home\.displaySeason/)
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).toMatch(/daily: "Daily"/)
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).toMatch(/expert: "Expert AI Analysis"/)
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).not.toMatch(/Change matchup/)
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).toMatch(/lastMatches: "Your last matches"/)
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).toMatch(/clearHistory: "Clear"/)
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).toMatch(/swap: "Swap"/)
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).not.toMatch(/Your \$\{home\.clubName\} nights/)
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).not.toMatch(/\$\{home\.clubName\} nights/)
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).not.toMatch(/Swap \$\{sides\}/)
    ...
    expect(readFileSync("components/simulator/MatchSetup.tsx", "utf8")).toMatch(/faceoff-vs">VS</)
    ...
    expect(readFileSync("app/page.tsx", "utf8")).toMatch(/What does Expert AI Analysis do\?/)
    expect(readFileSync("app/page.tsx", "utf8").replace("What does Expert AI Analysis do?", "")).not.toMatch(/Expert AI Analysis/)
    expect(readFileSync("app/simulate/page.tsx", "utf8")).not.toMatch(/Expert AI Analysis/)
    expect(readFileSync("data/collection-copy.ts", "utf8")).not.toMatch(/Expert AI Analysis/)
    expect(readFileSync("app/about/page.tsx", "utf8")).not.toMatch(/Expert AI Analysis/)
    expect(readFileSync("app/methodology/page.tsx", "utf8")).not.toMatch(/Expert AI Analysis/)
    expect(readFileSync("components/i18n/LocalizedPage.tsx", "utf8")).not.toMatch(/Expert AI Analysis/)
    expect(readFileSync("components/ui/MatchupRow.tsx", "utf8")).not.toMatch(/>OVR</)
